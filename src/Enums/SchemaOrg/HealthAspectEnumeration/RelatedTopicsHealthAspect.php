 ...
 *
 */
class RelatedTopicsHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "RelatedTopicsHealthAspect";
    const memberVal = "https://schema.org/RelatedTopicsHealthAspect";
}
