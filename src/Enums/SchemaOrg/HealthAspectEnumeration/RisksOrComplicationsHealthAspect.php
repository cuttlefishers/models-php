...
namespace OpenActive\Enums\HealthAspectEnumeration;
 ...
 *
 */
class RisksOrComplicationsHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "RisksOrComplicationsHealthAspect";
    const memberVal = "https://schema.org/RisksOrComplicationsHealthAspect";
}
