 ...
 *
 */
class LivingWithHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "LivingWithHealthAspect";
    const memberVal = "https://schema.org/LivingWithHealthAspect";
}
