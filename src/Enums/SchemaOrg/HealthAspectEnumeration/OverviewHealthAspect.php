 ...
 *
 */
class OverviewHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "OverviewHealthAspect";
    const memberVal = "https://schema.org/OverviewHealthAspect";
}
