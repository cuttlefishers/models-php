 ...
 *
 */
class SideEffectsHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "SideEffectsHealthAspect";
    const memberVal = "https://schema.org/SideEffectsHealthAspect";
}
