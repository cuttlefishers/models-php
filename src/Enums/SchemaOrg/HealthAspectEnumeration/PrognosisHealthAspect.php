 ...
 *
 */
class PrognosisHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "PrognosisHealthAspect";
    const memberVal = "https://schema.org/PrognosisHealthAspect";
}
