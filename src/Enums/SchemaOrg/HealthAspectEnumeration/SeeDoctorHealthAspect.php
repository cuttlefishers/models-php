 ...
 *
 */
class SeeDoctorHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "SeeDoctorHealthAspect";
    const memberVal = "https://schema.org/SeeDoctorHealthAspect";
}
