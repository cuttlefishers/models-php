 ...
 *
 */
class BenefitsHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "BenefitsHealthAspect";
    const memberVal = "https://schema.org/BenefitsHealthAspect";
}
