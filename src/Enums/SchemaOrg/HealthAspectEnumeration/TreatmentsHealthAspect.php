 ...
 *
 */
class TreatmentsHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "TreatmentsHealthAspect";
    const memberVal = "https://schema.org/TreatmentsHealthAspect";
}
