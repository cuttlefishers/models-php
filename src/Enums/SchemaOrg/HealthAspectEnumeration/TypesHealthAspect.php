 ...
 *
 */
class TypesHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "TypesHealthAspect";
    const memberVal = "https://schema.org/TypesHealthAspect";
}
