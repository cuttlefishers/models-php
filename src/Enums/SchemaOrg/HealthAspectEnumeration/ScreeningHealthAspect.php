 ...
 *
 */
class ScreeningHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "ScreeningHealthAspect";
    const memberVal = "https://schema.org/ScreeningHealthAspect";
}
