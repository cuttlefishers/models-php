 ...
 *
 */
class MayTreatHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "MayTreatHealthAspect";
    const memberVal = "https://schema.org/MayTreatHealthAspect";
}
