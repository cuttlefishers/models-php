 ...
 *
 */
class PreventionHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "PreventionHealthAspect";
    const memberVal = "https://schema.org/PreventionHealthAspect";
}
