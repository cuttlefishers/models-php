 ...
 *
 */
class CausesHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "CausesHealthAspect";
    const memberVal = "https://schema.org/CausesHealthAspect";
}
