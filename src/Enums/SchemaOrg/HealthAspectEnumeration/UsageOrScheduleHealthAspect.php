 ...
 *
 */
class UsageOrScheduleHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "UsageOrScheduleHealthAspect";
    const memberVal = "https://schema.org/UsageOrScheduleHealthAspect";
}
