 ...
 *
 */
class PatientExperienceHealthAspect extends \OpenActive\Enums\HealthAspectEnumeration
{
    const value = "PatientExperienceHealthAspect";
    const memberVal = "https://schema.org/PatientExperienceHealthAspect";
}
